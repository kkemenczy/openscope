...
function sandbox_commenter_link() {
	...
	echo  '<div class="avatar-image">' . $avatar . '</div> <div class="fn n">' . $commenter . '</div>';
}
...
function sandbox_comments($comment, $args, $depth) {
		...
		?>
			<<?php echo $tag ?> id="comment-<?php comment_ID() ?>" class="<?php sandbox_comment_class() ?>">
...
<?php // echo the comment reply link with help from Justin Tadlock http://justintadlock.com/ and Will Norris http://willnorris.com/
					...
					<div class="comment-reply-link">
						<?php comment_reply_link(array_merge($args, array(
							...
							'reply_text' => __('<span><span>Reply</span></span>','sandbox'), 
