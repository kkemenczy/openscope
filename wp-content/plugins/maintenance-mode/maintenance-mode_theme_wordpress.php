...
<?php
 ...
 ?>
	...
	h1 a { background: url("/wp-content/themes/libreoffice/images/logo.png") no-repeat 50% 50% transparent !important; }
...
<body class="login">
	...
	<div id="login">
		...
		<h1><a href="http://libreoffice.hu" title="LibreOffice &ndash; ingyen irodai programcsomag"><img src="/wp-content/themes/libreoffice/images/logo.png"></a></h1>
	
		<form name="loginform" id="loginform" action="<?php echo site_url('wp-login.php', 'login_post') ?>" method="post">
			<?php echo $this->mamo_template_tag_message(); ?>
		</form>
 
		<p id="nav" style="margin: 0 auto; text-align: center;">
