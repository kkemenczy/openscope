	...
	if ($username == '') {
        ...
        $i = 0;
          ...
          if($update) {				
            ...
            echo sprintf( __('%s', 'twitter-for-wordpress'),' <span class="twitter-timestamp"><a href="'.$link.'" class="twitter-link"><abbr title="' . date(__('Y/m/d H:i:s'), $time) . '">' . $h_time . '</abbr></a></span>' );
