...
// Hidden DIV output
	...
	$hidden_div = '<span id="'.$div_id.'" class="mydiv" style="display:none;"><img src="'.$gravatar.'" alt="gravatar" /><span class="ae_close"><a href="javascript:;" onmousedown="toggleDiv(\''.$div_id.'\');">bezárás</a></span><span class="ae_top"><b>Szerző: '.get_the_author().'</b></span>
		<span class="ae_body"><b>Név</b>: '.get_the_author_firstname().' '.get_the_author_lastname().'<br /><b>Weboldal:</b> <a href="'.get_the_author_url().'">'.get_the_author_url().'</a><br /></span><span class="ae_about"><b></b> '.get_the_author_description().'</span><span class="ae_body"><a href="'.$author_posts_link.'">A szerző további írásai</a> ('.get_the_author_posts().')</span></span>';
